...
func (x *AliyunKmsKey) GetArn() string {
	if x != nil {
		return x.Arn
	}
	return ""
...
func (x *AliyunKmsKey) GetContext() map[string]string {
	if x != nil {
		return x.Context
	}
	return nil
...
var file_keyservice_keyservice_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0x92, 0x01, 0x0a, 0x0c, 0x41, 0x6c, 0x69, 0x79, 0x75, 0x6e, 0x4b, 0x6d, 0x73, 0x4b,
	0x65, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x61, 0x72, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x03, 0x61, 0x72, 0x6e, 0x12, 0x34, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x18,
	0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x41, 0x6c, 0x69, 0x79, 0x75, 0x6e, 0x4b, 0x6d,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0x6c, 0x0a, 0x0a, 0x4b, 0x65, 0x79, 0x53, 0x65, 0x72,
...
var file_keyservice_keyservice_proto_goTypes = []interface{}{
	...
	(*AliyunKmsKey)(nil),     // 11: AliyunKmsKey
	nil,                      // 12: KmsKey.ContextEntry
	nil,                      // 13: AliyunKmsKey.ContextEntry
}
var file_keyservice_keyservice_proto_depIdxs = []int32{
	...
	11, // 6: Key.aliyun_kms_key:type_name -> AliyunKmsKey
	...
	13, // 10: AliyunKmsKey.context:type_name -> AliyunKmsKey.ContextEntry
	7,  // 11: KeyService.Encrypt:input_type -> EncryptRequest
	9,  // 12: KeyService.Decrypt:input_type -> DecryptRequest
	8,  // 13: KeyService.Encrypt:output_type -> EncryptResponse
	10, // 14: KeyService.Decrypt:output_type -> DecryptResponse
